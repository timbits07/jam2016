	...
	*/
	...
	if( !function_exists('gdlr_generate_style_custom') ){
		function gdlr_generate_style_custom( $options ){
			...
			$half_container = intval($theme_option['container-width']) / 2;
			fwrite($file_stream, '.half-container{ max-width: ' . $half_container . 'px; }' . "\n");
			...
			foreach($skins as $skin){
				...
				$style .= '#class# .gdlr-testimonial-item.modern-style .testimonial-gimmick { border-right-color: ' . $skin['element-background'] . '; }' . "\n";
							...
							'options' => array(
								...
								'top-bar' => array(
									...
									'options' => array(
										...
										'top-bar-right-text1' => array(
											'title' => __('Top Bar Right Text 1', 'gdlr_translate'),
											'type' => 'textarea',									
										),
										'top-bar-right-text2' => array(
											'title' => __('Top Bar Right Text 2', 'gdlr_translate'),
											'type' => 'textarea',									
										),
									)
								),
							...
							'options' => array(
									...
									'options' => array(						
										...
										'main-navigation-text-hover' => array(
											...
											'selector'=> '.gdlr-main-menu > li:hover > a, .gdlr-main-menu > li.current-menu-item > a, ' .
												...
												'.gdlr-navigation-wrapper .gdlr-main-menu > li:hover > a:before, .gdlr-navigation-wrapper .gdlr-main-menu > li.current-menu-item > a:before, ' . 
												'.gdlr-navigation-wrapper .gdlr-main-menu > li.current-menu-ancestor > a:before{ color: #gdlr#; }'
										),		
										'bucket-color' => array(
								...
								'main-navigation-color' => array(
									...
									'options' => array(
										...
										'search-box-icon-color' => array(
											'title' => __('Header Search Box Icon', 'gdlr_translate'),
											'type' => 'colorpicker',
											'data-type' => 'rgba',
											'default' => '#b4b4b4',
								...
								'sidebar-color' => array(
									...
									'options' => array(
										...
										'sidebar-practice-title-color' => array(
											'title' => __('Sidebar Practice/Attorney Title Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#323232',
											'selector'=> '.gdlr-sidebar .gdlr-sidebar-title-color, .gdlr-sidebar-title-color a{ color: #gdlr#; }'
										),	
										'sidebar-practice-info-color' => array(
											'title' => __('Sidebar Practice/Attorney Info Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#999999',
											'selector'=> '.gdlr-sidebar .gdlr-sidebar-info-color, .gdlr-sidebar-info-color a{ color: #gdlr#; }'
										),	
								...
								'content-item-2' => array(
									...
									'options' => array(		
										...
										'service-half-background-left-title' => array(
											'title' => __('Service Half Background Left Title', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-service-half-background-item .gdlr-left-service-title, .service-half-background-icon{ color: #gdlr#; }'
										),
										'service-half-background-left-content' => array(
											'title' => __('Service Half Background Left Content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-service-half-background-item .gdlr-left-service-content{ color: #gdlr#; }'
										),
										'service-half-background-right-title' => array(
											'title' => __('Service Half Background Right Title', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#393939',
											'selector'=> '.gdlr-service-half-background-item .gdlr-right-service-title{ color: #gdlr#; }'
										),
										'service-half-background-right-caption' => array(
											'title' => __('Service Half Background Right Caption', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#828282',
											'selector'=> '.gdlr-service-half-background-item .gdlr-right-service-caption{ color: #gdlr#; }'
										),
										...
										'stunning-text-title-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#1e1e1e',
											'selector'=> '.stunning-item-title, .stunning-text-title{ color: #gdlr#; }'
										),
										'stunning-text-caption-color' => array(
											'title' => __('Stunning Text Caption Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ec4933',
											'selector'=> '.stunning-item-caption, .stunning-item-icon, .stunning-text-caption{ color: #gdlr#; }'
										),
										'stunning-text-background' => array(
											'title' => __('Stunning Text (shortcode) Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f3f3f3',
											'selector'=> '.gdlr-stunning-text-item.with-padding{ background-color: #gdlr#; }'
										),
										'stunning-text-border' => array(
											'title' => __('Stunning Text (shortcode) Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f3f3f3',
								...
								'portfolio-color' => array(
									...
									'options' => array(
										'portfolio-filter-button-text' => array(
											...
											'type' => 'colorpicker',
											'default' => '#909090',
											'selector'=> '.portfolio-item-filter a, .practice-item-filter a{ color: #gdlr#; } '
										),					
										'portfolio-filter-button-active-text' => array(
											'title' => __('Portfolio Filter Button Text Active', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ec4933',
											'selector'=> '.portfolio-item-filter a:hover, .portfolio-item-filter a.active, ' . 
												'.practice-item-filter a:hover, .practice-item-filter a.active{ color: #gdlr#; }' . 
												'.portfolio-item-filter-gimmick, .practice-item-filter-gimmick{ background: #gdlr#; }'
										),	
								...
								'practice-attorney-color' => array(
									'title' => __('Practice / Attorney', 'gdlr_translate'),
									'options' => array(
										'single-attorney-name' => array(
											'title' => __('Single Attorney Name', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ec4933',
											'selector'=> '.single-attorney .gdlr-attorney-info-title { color: #gdlr#; }'
										),	
										'practice-item-title-color' => array(
											'title' => __('Practice Item Title Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#2a2a2a',
											'selector'=> '.practice-title a { color: #gdlr#; }'
										),	
										'practice-thumbnail-hover-color' => array(
											'title' => __('Practice Thumbnail Hover Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ec4933',
											'selector'=> '.single-practice .gdlr-practice-thumbnail, ' .
												'.gdlr-classic-practice .gdlr-practice-thumbnail, ' .
												'.gdlr-modern-practice .gdlr-practice-thumbnail-overlay { background-color: #gdlr#; }'
										),
										'practice-pdf-button-text' => array(
											'title' => __('Practice PDF Button Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#6f6f6f',
											'selector'=> '.single-practice .gdlr-pdf-download{ color: #gdlr#; }'
										),
										'practice-pdf-button-border' => array(
											'title' => __('Practice PDF Button Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#dadada',
											'selector'=> '.single-practice .gdlr-pdf-download{ border-color: #gdlr#; }'
										),
									)
								),
									...
									'options' => array(
										...
										'testimonial-box-background' => array(
											...
											'selector'=> '.gdlr-testimonial-item .testimonial-item-inner, ' . 
												...
												'.gdlr-testimonial-item.modern-style .testimonial-gimmick { border-right-color: #gdlr#; }'
										),			
								...
								'slider-input-color' => array(
									...
									'options' => array(
										...
										'slider-outer-nav-background' => array(
											...
											'type' => 'colorpicker',
											'default' => '#f3f3f3',
											'selector'=> '.gdlr-item-title-wrapper .gdlr-flex-prev, .gdlr-item-title-wrapper .gdlr-flex-next, .gdlr-widget-title-nav i{ background-color: #gdlr#; }',
										...
										'slider-outer-nav-icon' => array(
											...
											'type' => 'colorpicker',
											'default' => '#9b9b9b',
											'selector'=> '.gdlr-item-title-wrapper .gdlr-flex-prev, .gdlr-item-title-wrapper .gdlr-flex-next, .gdlr-widget-title-nav i{ color: #gdlr#; }',
											'description'=> __('The slider navigation that does not be inside the slider area.', 'gdlr_translate')
										),
										'slider-outer-nav-background-hover' => array(
											'title' => __('Slider Outer Navigation Hover Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ec4933',
											'selector'=> '.gdlr-item-title-wrapper .gdlr-flex-prev:hover, .gdlr-item-title-wrapper .gdlr-flex-next:hover,.gdlr-widget-title-nav i:hover{ background-color: #gdlr#; }',
											'description'=> __('The slider navigation that does not be inside the slider area.', 'gdlr_translate')
										),			
										'slider-outer-nav-icon-hover' => array(
											'title' => __('Slider Outer Navigation Hover Icon', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-item-title-wrapper .gdlr-flex-prev:hover, .gdlr-item-title-wrapper .gdlr-flex-next:hover, .gdlr-widget-title-nav i:hover{ color: #gdlr#; }',
											'description'=> __('The slider navigation that does not be inside the slider area.', 'gdlr_translate')
										),										
