...
<?php			
		...
		function gdlr_get_default_admin_option() {
			...
			if(empty($sidebar_option)){
				update_option('gdlr_sidebar_name', 
					array( 'blog', 'blog-left', 'portfolio', 'portfolio-left', 'shortcodes',  'woocommerce',  'Features', 'Archives', 'contact', 'practice area', 'Q&A')
				);
			}
			
			$google_font_list = get_option(THEME_SHORT_NAME . '_google_font_list', array());
			if( empty($google_font_list) ){
				$font_text  = 'a:2:{s:5:"Cardo";a:2:{s:7:"subsets";a:4:{i:0;s:5:"greek";i:1;s:5:"latin";i:2;s:9:"latin-ext";i:3;s:9:"greek-ext";}s:8:"variants";a:3:{i:0;s:7:"regular";i:1;s:6:"italic";i:2;s:3:"700";}}s:9:"Open Sans";a:2:{s:7:"subsets";a:7:{i:0;s:5:"greek";i:1;s:12:"cyrillic-ext";i:2;s:8:"cyrillic";i:3;s:5:"latin";i:4;s:9:"latin-ext";i:5;s:10:"vietnamese";i:6;s:9:"greek-ext";}s:8:"variants";a:10:{i:0;s:3:"300";i:1;s:9:"300italic";i:2;s:7:"regular";i:3;s:6:"italic";i:4;s:3:"600";i:5;s:9:"600italic";i:6;s:3:"700";i:7;s:9:"700italic";i:8;s:3:"800";i:9;s:9:"800italic";}}}';
	...
	if( !function_exists('gdlr_excerpt_more') ){
		function gdlr_excerpt_more( $more ) {
			global $gdlr_excerpt_read_more, $gdlr_excerpt_text; if( !$gdlr_excerpt_read_more ) return '...';
			$gdlr_excerpt_text = empty($gdlr_excerpt_text)? __( 'Read More', 'gdlr_translate' ) : $gdlr_excerpt_text;
			
			return '... <div class="clear"></div><a href="' . get_permalink() . '" class="excerpt-read-more">' . $gdlr_excerpt_text . '</a>';
		}
	}
