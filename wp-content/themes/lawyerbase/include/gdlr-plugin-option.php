	...
	*/
	...
	if( !function_exists('gdlr_register_portfolio_admin_option') ){
		...
		function gdlr_register_portfolio_admin_option( $array ){		
			...
			$practice_option = array(
				'title' => __('Attorney / Practice', 'gdlr_translate'),
				'options' => array(
					'attorney-thumbnail-size' => array(
						'title' => __('Single Practice Thumbnail Size', 'gdlr_translate'),
						'type'=> 'combobox',
						'options'=> gdlr_get_thumbnail_list(),
						'default'=> 'post-thumbnail-size'
					),		
					'practice-thumbnail-size' => array(
						'title' => __('Single Practice Thumbnail Size', 'gdlr_translate'),
						'type'=> 'combobox',
						'options'=> gdlr_get_thumbnail_list(),
						'default'=> 'post-thumbnail-size'
					),
					'practice-sidebar-template' => array(
						'title' => __('Default Practice Sidebar', 'gdlr_translate'),
						'type' => 'radioimage',
						'options' => array(
					...
					'practice-sidebar-left' => array(
						'title' => __('Default Practice Sidebar Left', 'gdlr_translate'),
						'type' => 'combobox',
						'options' => $gdlr_sidebar_controller->get_sidebar_array(),		
						'wrapper-class'=>'left-sidebar-wrapper both-sidebar-wrapper practice-sidebar-template-wrapper',											
					),
					'practice-sidebar-right' => array(
						'title' => __('Default Practice Sidebar Right', 'gdlr_translate'),
						'type' => 'combobox',
						'options' => $gdlr_sidebar_controller->get_sidebar_array(),
						'wrapper-class'=>'right-sidebar-wrapper both-sidebar-wrapper practice-sidebar-template-wrapper',
					),	
				)
			);
			$array['general']['options']['practice-style'] = $practice_option;
