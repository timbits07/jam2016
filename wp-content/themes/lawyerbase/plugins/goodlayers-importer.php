	...
	*/
	...
	if( !function_exists('gdlr_add_import_action') ){
		function gdlr_add_import_action(){
			...
			update_option( 'page_on_front', 3928 );
	...
	//$widget_data = array();
	//$widget_list = array('sidebars_widgets', 'widget_archives', 'widget_calendar', 'widget_gdlr-attorney-slider-widget', 'widget_gdlr-recent-practice-widget',
