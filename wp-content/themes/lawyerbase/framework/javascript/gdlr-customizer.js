...
var color_option = [ {name: "top-bar-text-color", selector: ".top-navigation-wrapper{ color: #gdlr#; }"},
{name: "top-bar-link-color", selector: ".top-navigation-wrapper a{ color: #gdlr#; }"},
{name: "header-background-color", selector: ".gdlr-header-inner{ background-color: #gdlr#; }.gdlr-navigation-wrapper .gdlr-main-menu > li > a:before{ color: #gdlr#; }"},
{name: "main-navigation-text", selector: ".gdlr-main-menu > li > a{ color: #gdlr#; }"},
{name: "main-navigation-text-hover", selector: ".gdlr-main-menu > li:hover > a, .gdlr-main-menu > li.current-menu-item > a, .gdlr-main-menu > li.current-menu-ancestor > a{ color: #gdlr#; opacity: 1; filter: alpha(opacity=100); }.gdlr-navigation-wrapper .gdlr-main-menu > li:hover > a:before, .gdlr-navigation-wrapper .gdlr-main-menu > li.current-menu-item > a:before, .gdlr-navigation-wrapper .gdlr-main-menu > li.current-menu-ancestor > a:before{ color: #gdlr#; }"},
...
{name: "search-box-icon-color", selector: ".gdlr-navigation-wrapper .gdlr-menu-search-button{ color: #gdlr#; }"},
{name: "search-box-background-color", selector: ".gdlr-menu-search{ background: #gdlr#; }"},
...
{name: "sidebar-practice-title-color", selector: ".gdlr-sidebar .gdlr-sidebar-title-color, .gdlr-sidebar-title-color a{ color: #gdlr#; }"},
{name: "sidebar-practice-info-color", selector: ".gdlr-sidebar .gdlr-sidebar-info-color, .gdlr-sidebar-info-color a{ color: #gdlr#; }"},
...
{name: "service-half-background-left-title", selector: ".gdlr-service-half-background-item .gdlr-left-service-title, .service-half-background-icon{ color: #gdlr#; }"},
{name: "service-half-background-left-content", selector: ".gdlr-service-half-background-item .gdlr-left-service-content{ color: #gdlr#; }"},
{name: "service-half-background-right-title", selector: ".gdlr-service-half-background-item .gdlr-right-service-title{ color: #gdlr#; }"},
{name: "service-half-background-right-caption", selector: ".gdlr-service-half-background-item .gdlr-right-service-caption{ color: #gdlr#; }"},
{name: "skill-text-color", selector: ".gdlr-skill-item-wrapper{ color: #gdlr#; }"},
{name: "stunning-text-title-color", selector: ".stunning-item-title, .stunning-text-title{ color: #gdlr#; }"},
{name: "stunning-text-caption-color", selector: ".stunning-item-caption, .stunning-item-icon, .stunning-text-caption{ color: #gdlr#; }"},
...
{name: "portfolio-filter-button-text", selector: ".portfolio-item-filter a, .practice-item-filter a{ color: #gdlr#; } "},
{name: "portfolio-filter-button-active-text", selector: ".portfolio-item-filter a:hover, .portfolio-item-filter a.active, .practice-item-filter a:hover, .practice-item-filter a.active{ color: #gdlr#; }.portfolio-item-filter-gimmick, .practice-item-filter-gimmick{ background: #gdlr#; }"},
...
{name: "single-attorney-name", selector: ".single-attorney .gdlr-attorney-info-title { color: #gdlr#; }"},
{name: "practice-item-title-color", selector: ".practice-title a { color: #gdlr#; }"},
{name: "practice-thumbnail-hover-color", selector: ".single-practice .gdlr-practice-thumbnail, .gdlr-classic-practice .gdlr-practice-thumbnail, .gdlr-modern-practice .gdlr-practice-thumbnail-overlay { background-color: #gdlr#; }"},
{name: "practice-pdf-button-text", selector: ".single-practice .gdlr-pdf-download{ color: #gdlr#; }"},
{name: "practice-pdf-button-border", selector: ".single-practice .gdlr-pdf-download{ border-color: #gdlr#; }"},
...
{name: "testimonial-box-background", selector: ".gdlr-testimonial-item .testimonial-item-inner, .gdlr-testimonial-item .testimonial-author-image{ background-color: #gdlr#; }.gdlr-testimonial-item.modern-style .testimonial-gimmick { border-right-color: #gdlr#; }"},
...
{name: "slider-outer-nav-background", selector: ".gdlr-item-title-wrapper .gdlr-flex-prev, .gdlr-item-title-wrapper .gdlr-flex-next, .gdlr-widget-title-nav i{ background-color: #gdlr#; }"},
{name: "slider-outer-nav-icon", selector: ".gdlr-item-title-wrapper .gdlr-flex-prev, .gdlr-item-title-wrapper .gdlr-flex-next, .gdlr-widget-title-nav i{ color: #gdlr#; }"},
{name: "slider-outer-nav-background-hover", selector: ".gdlr-item-title-wrapper .gdlr-flex-prev:hover, .gdlr-item-title-wrapper .gdlr-flex-next:hover,.gdlr-widget-title-nav i:hover{ background-color: #gdlr#; }"},
{name: "slider-outer-nav-icon-hover", selector: ".gdlr-item-title-wrapper .gdlr-flex-prev:hover, .gdlr-item-title-wrapper .gdlr-flex-next:hover, .gdlr-widget-title-nav i:hover{ color: #gdlr#; }"},
