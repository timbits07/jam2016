(function($){
	...
	$(document).ready(function(){
		...
		$('.portfolio-item-wrapper .gdlr-pagination.gdlr-ajax .page-numbers').gdlr_bind_portfolio_pagination();
	});
	...
	$(window).load(function(){
		...
		$('.portfolio-item-filter').each(function(){
			var active = $(this).children('.active');
			
			$(this).children('.portfolio-item-filter-gimmick').css({
				width: active.width(),
		...
		$('.portfolio-item-filter a').hover(function(){
			var active = $(this);
			
			$(this).siblings('.portfolio-item-filter-gimmick').animate({
				width: active.width(),
				left: active.position().left + 15,
				top: active.position().top + 21
